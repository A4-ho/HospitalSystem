...
import src.repositories.ApointmentsRepository;
...
public class HospitalSystem {
    ...
    public static void main(String[] args) {
        ...
        if (connection != null) {
            ...
            ApointmentsRepository apointmentsRepository = new ApointmentsRepository(connection);
    ...
    private static void bookAppointment(DoctorRepository doctorRepository, ApointmentsRepository apointmentsRepository) {
