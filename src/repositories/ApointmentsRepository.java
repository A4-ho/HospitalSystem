...
import src.repositories.interfaces.IApointments;
...
public class ApointmentsRepository implements IApointments {
    private final Connection connection;

    public ApointmentsRepository(Connection connection) {
